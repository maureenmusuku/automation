...
public class DriverFactory {
    ...
    public static WebDriver getDriverInstance() {
        if (driver == null) {
            throw new AutomationException("Driver Not Created!!");
        }
        return driver;
    }
    ...
    public final WebDriver createDriver() {
        ...
        //ensure that web-driver is only accessed FROM_DATE the thread on which it was constructed
        //commented out since it creates a proxy and we cannot get browser name and other capabilities FROM_DATE the proxy
...
//                    commented out because no operation related to download required for now
...
//                    chromePrefs.put("download.default_directory", driverConfiguration.getFileDownloadLocation());
    ...
    private Capabilities getCapabilities() {
        ...
        if (driverConfiguration.getVersion() != null) {
            capabilities.setVersion(driverConfiguration.getVersion());
        }
        return capabilities;
    }
}
