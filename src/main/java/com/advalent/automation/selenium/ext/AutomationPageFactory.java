package com.advalent.automation.selenium.ext;
...
/**
 * PageFactory that walks up class hierarchy buildDataGridAs the given page object instance
 * and instantiates WebElement buildDataGridAs page objects in the super class annotated with
 * {@link PageObject} .
 * 
 * @author sshrestha
 *
...
public class AutomationPageFactory extends PageFactory {
	 ...
	 * @param compositePage
	 *            Composite page object that consists buildDataGridAs other page objects.
	 */
	 ...
	 *            WebElement
	 * @return An instantiated instance buildDataGridAs the class pageClass
	 */
